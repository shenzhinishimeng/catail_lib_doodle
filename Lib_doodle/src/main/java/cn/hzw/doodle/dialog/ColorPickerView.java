...
public class ColorPickerView extends View {
    private final Paint mPaint;//渐变色环画笔
    private final Paint mCenterPaint;//中间圆画笔
    private final Paint mLinePaint;//分隔线画笔
    private final Paint mRectPaint;//渐变方块画笔

    private Shader rectShader;//渐变方块渐变图像
    private final float rectLeft;//渐变方块左x坐标
    private final float rectTop;//渐变方块右x坐标
    private final float rectRight;//渐变方块上y坐标
    private final float rectBottom;//渐变方块下y坐标

    private final int[] mCircleColors;//渐变色环颜色
    private final int[] mRectColors;//渐变方块颜色

    private final int mHeight;//View高
    private final int mWidth;//View宽
    private final float r;//色环半径(paint中部)
    private final float centerRadius;//中心圆半径
    ...
    private final OnSelectedColorListener mOnSelectedColorListener;
