...
public class DoodleView extends View implements IDoodle {
    ...
    private final IDoodleListener mDoodleListener;

    private final Bitmap mBitmap; // 当前涂鸦的原图（旋转后）
    ...
    // 保存涂鸦操作，便于撤销
    private final CopyOnWriteArrayList<IDoodleItem> mItemStack = new CopyOnWriteArrayList<IDoodleItem>();
    ...
    private final Paint mZooomerPaint;
    private final Paint mZoomerTouchPaint;
    ...
    private final Map<IDoodlePen, IDoodleTouchDetector> mTouchDetectorMap = new HashMap<>();

    private final DoodleViewInner mInner;
    private final RectF mDoodleBound = new RectF();
    ...
    private final Matrix mTouchEventMatrix = new Matrix();
